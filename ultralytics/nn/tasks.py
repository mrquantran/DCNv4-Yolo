...
from ultralytics.nn.modules.dcnv4_block import DeformableConv2d

globals()["DeformableConv2d"] = DeformableConv2d
...
class DetectionModel(BaseModel):
    ...
    def __init__(self, cfg="yolo11n.yaml", ch=3, nc=None, verbose=True):  # model, input channels, number of classes
        ...
        print('detection model', self.yaml)
...
class ClassificationModel(BaseModel):
    ...
    def _from_yaml(self, cfg, ch, nc, verbose):
        ...
        print('classification model', self.yaml)
        self.model, self.save = parse_model(deepcopy(self.yaml), ch=ch, verbose=verbose)  # model, savelist
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    import ast
    print('here')
    print("DeformableConv2d" not in globals())
